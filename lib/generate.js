...
var VERBOSE, argv, asSentence, bestMatch, context, contextAsString, expandTokens, filename, flatten, fs, generate, grammar, k, listKeys, listValues, minimist, parse, randomChoice, ref, scoreKey, splitToken, v,
  slice = [].slice;

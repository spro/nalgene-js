...
expandToken = function(token, grammar, context) {
  var expanded, formatted, formatter, group_expanded, group_token, i, item, joiner, len, phrase, phrase_expanded, phrase_token, ref1, secondary, synonym, synonym_token, value, value_token, word_token;
  expanded = [];
...
exports.generate = generate = function(grammar, context) {
  return fixPunctuation(expandPhrase(grammar.phrases.root, grammar, context));
};

...
do ->
  ...
  grammar = {
    ParserRules: [
          ...
          {"name": "value_token$string$1", "symbols": [{"literal":"*"}, {"literal":"%"}], "postprocess": (d) -> d.join('')},
          {"name": "value_token", "symbols": [{"literal":"$"}, "word", "value_token$string$1", "word", {"literal":":"}, "joiners"], "postprocess": (d) -> Object.assign {value: d[1], expander: d[3]}, d[5]},
          ...
          {"name": "value_token$string$2", "symbols": [{"literal":"*"}, {"literal":"%"}], "postprocess": (d) -> d.join('')},
          {"name": "value_token", "symbols": [{"literal":"$"}, "word", "value_token$string$2", "word"], "postprocess": (d) -> Object.assign {value: d[1]}, {expander: d[3]}},
          ...
          {"name": "esc_word_char$string$10", "symbols": [{"literal":"\\"}, {"literal":")"}], "postprocess": (d) -> d.join('')},
          {"name": "esc_word_char", "symbols": ["esc_word_char$string$10"], "postprocess": -> ")"}
      ],
    ParserStart: "blocks"
  }
